...
.PHONY: vpp
vpp:
ifneq ($(CONFIG_APP_VPP)$(FORCE), "n")
ifeq ($(DESTARCH),arm64)
	@[ $(DISTROTYPE) != ubuntu -a $(DISTROTYPE) != yocto -o $(DISTROSCALE) = desktop -o \
	  $(DISTROSCALE) = lite -o $(DISTROSCALE) = tiny ] && exit || \
	 $(call fbprint_b,"vpp") && \
	 $(call fetch-git-tree,vpp,apps/networking) && \
	...
	@$(call fbprint_w,INFO: VPP is not enabled by default in configs/$(CFGLISTYML))
endif
